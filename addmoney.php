...
<style>
    /* =========================================
       COLOR CONFIGURATION
       (Matches Index Page Logic)
       ========================================= */
    :root {
        --primary-color: #DC2626;       /* Default Red */
        --primary-color-dark: #b91c1c;  /* Darker Red */
    }
    ...
    /* UPDATED: Focus color uses variable */
    .input-flat:focus {
        border-color: var(--primary-color);
        box-shadow: 0 0 0 2px rgba(220, 38, 38, 0.1); /* Red Glow */
    }

    /* UPDATED: Button uses variable */
    .btn-flat-main {
    ...
    .btn-flat-main:hover { background-color: var(--primary-color-dark); }
    ...
    <div class="main-card">
        ...
        <div class="p-5">
            ...
            <div class="video-title">
                <i class="fa-solid fa-circle-play" style="color: var(--primary-color);"></i> 
