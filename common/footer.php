...
$site_name = isset($conn) ? getSetting($conn, 'site_name') : 'TopupBD';
$site_logo = isset($conn) ? getSetting($conn, 'site_logo') : '';

// Links
$fb_link = isset($conn) ? getSetting($conn, 'facebook') : '#';
$ig_link = isset($conn) ? getSetting($conn, 'instagram') : '#';
$yt_link = isset($conn) ? getSetting($conn, 'youtube') : '#';
$email_link = isset($conn) ? getSetting($conn, 'contact_email') : '#';
$tg_link = isset($conn) ? getSetting($conn, 'telegram_link') : '#';
$wa_link = isset($conn) ? getSetting($conn, 'whatsapp_number') : ''; 
$helpline_num = isset($conn) ? getSetting($conn, 'fab_link') : ''; 
?>
