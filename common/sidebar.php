...
<div id="userSidebar" class="fixed inset-y-0 right-0 w-[280px] bg-white transform translate-x-full transition-transform duration-300 z-[99999] lg:hidden flex flex-col border-l border-gray-200 font-bree shadow-2xl">
    ...
    <div class="px-6 pb-4 pt-4">
        <?php if($is_log): ?>
            <a href="logout.php" style="background-color: var(--primary-color) !important;" class="hover:opacity-90 text-white text-sm font-medium w-full py-2.5 rounded-lg flex items-center justify-center gap-2 transition-opacity shadow-sm">
        ...
        <?php else: ?>
            <a href="login.php" style="background-color: var(--primary-color) !important;" class="hover:opacity-90 text-white text-sm font-medium w-full py-2.5 rounded-lg block text-center transition-opacity shadow-sm">Login</a>
        <?php endif; ?>
    </div>
    ...
    <div class="p-6 border-t border-gray-100 mt-auto">
        <a href="<?php echo isset($conn) ? getSetting($conn, 'fab_link') : '#'; ?>" target="_blank" style="background-color: var(--primary-color) !important;" class="hover:opacity-90 text-white w-full py-3 rounded-lg flex items-center justify-center gap-3 font-medium transition-opacity shadow-sm">
