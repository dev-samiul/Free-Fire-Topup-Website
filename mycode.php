...
<style>
    /* =========================================
       COLOR CONFIGURATION
       (Inherits from Header, Fallback provided)
       ========================================= */
    :root {
...
<div class="container mx-auto px-4 py-6 mb-20 max-w-lg">
    ...
    <div class="main-card">
        ...
        ?>
        <div class="total-bar">
            Total Spent : <span class="text-primary font-bold">৳ <?php echo number_format($total_val, 2); ?></span>
        </div>
                ...
                <div class="voucher-item">
                    <div class="flex gap-3 items-center mb-1">
                        ...
                        <div class="text-right">
                             <span class="font-bold text-primary text-sm">৳ <?php echo number_format($row['amount'], 2); ?></span>
...
<script>
    function copyToClipboard(text, btn) {
        navigator.clipboard.writeText(text).then(() => {
            ...
            // UPDATED JS TO USE DYNAMIC VARIABLE
