...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col items-center mb-6">
        <div class="w-28 h-28 rounded-full p-1 shadow-lg mb-3 flex items-center justify-center bg-white avatar-gradient-ring">
        ...
        <h2 class="text-primary text-sm font-bold">Hi, <?php echo htmlspecialchars($u['name']); ?></h2>
